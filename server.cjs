...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Sistema de Desarrollo Profesional para Educación Especial Inclusiva";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Educador de Educación Especial";
process.env.TABLE_NAME = process.env.TABLE_NAME || "educador_de_educaci_n_especial_records";
'use strict';
